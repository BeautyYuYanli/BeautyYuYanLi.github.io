---
title: IOI2005Riv河流|题解
date: 2018-5-16 12:12:12
tags: [dp,题解]
thumbnail: https://pics1.beautyyu.top/origin/CcUwBF.jpg
---

私以为没必要转二叉树

本题应为三维dp,体现的是**泛化物品的背包**的思想(详见<背包九讲>)

只是决定价值(本题体现为`节省的费用`)的因素不是单一的重量(体现为`产树量`),此外还有一个维度`据上一个伐木场的距离`

具体来说,一个伐木场`节省的费用`可以是其`自己和儿子们的产树量之和`和`上一个伐木场的距离`的成绩,这样我们就简单地设计出了状态转移策略
...
![](https://pics1.beautyyu.top/origin/CcUwBF.jpg)